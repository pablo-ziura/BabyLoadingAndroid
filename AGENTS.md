...
- Keep AGP/R8 code and resource optimization enabled for `release`. Do not add broad keep rules; every exception must be narrowly scoped, justified, and verified against an optimized release artifact.
