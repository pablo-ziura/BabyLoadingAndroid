...
class GalleryPresentationTest {
    ...
    fun bitmapSamplingUsesPowersOfTwoWithoutUndershootingTarget() {
        assertEquals(1, GalleryBitmapDecoder.calculateInSampleSize(400, 300, 512))
        assertEquals(2, GalleryBitmapDecoder.calculateInSampleSize(4000, 3000, 1000))
        assertEquals(4, GalleryBitmapDecoder.calculateInSampleSize(8000, 6000, 1000))
    }
